...
class RepositorioRecuperacionClave {
    ...
    //esta funcion es para saber si la url secreta existe en la base de dastos
    ...
    //crear otra funcion para hacer que el usuario solo pueda realizar una sola vez la petiicon de recuperacion de clave
}