...
class ValidadorEntradaEditada extends Validador {
    ...
    public function __construct($titulo, $titulo_original, $url, $url_original, $texto, $texto_original, 
            $checkbox, $checkbox_original, $conexion) {
    ...
    public function obtener_checkbox_original() {
        return $this-> checkbox_origianal;
    }
