...
class ValidadorRegistro{
    ...
    public function  __construct($nombre, $email, $clave1, $clave2, $conexion){
        ...
        $this->error_clave2= $this-> validar_clave2($clave2, $clave1);
    ...
    private function validar_nombre($conexion, $nombre){
        ...
        if (strlen($nombre)<5){
            return "El nombre debe contener más de 4 caracteres.";
        }
        ...
        if (RepositorioUsuario :: nombre_existe($conexion, $nombre)) {
            return "Este nombre de usuario ya está en uso. Por favor, pruebra otro nombre.";
        }
    ...
    private function validar_email($conexion, $email){
        ...
        if (RepositorioUsuario :: email_existe($conexion, $email)){
            return "Este email ya está en uso. Por favor, pruebre otro email o <a href='#'>Intente recuperar su contraseña</a>.";
        }
    ...
    private function validar_clave2($clave2, $clave1){
        ...
        if ($clave1 !== $clave2){
            return "Ambas claves deben coincidir";
        }
