...
if (isset($_POST['guardar_cambios_entrada'])) {
    ...
    $validador = new ValidadorEntradaEditada($_POST['titulo'], $_POST['titulo-original'], $_POST['url'], $_POST['url-original'], 
            htmlspecialchars($_POST['texto']), $_POST['texto-original'], $entrada_publica_nueva, $_POST['publicar-original'], 
    ...
    if (!$validador -> hay_cambios()) {
        ...
        if ($validador -> entrada_valida()) {
            $cambio_efectuado = RepositorioEntrada :: actualizar_entrada(Conexion::obtener_conexion(), $_POST['id-entrada'], 
                    $validador -> obtener_titulo(), $validador -> obtener_url(), $validador -> obtener_texto(), 
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <form class="formulario-nueva-entrada" method="post" action="<?php echo RUTA_EDITAR_ENTRADA; ?>">
                <?PHP
