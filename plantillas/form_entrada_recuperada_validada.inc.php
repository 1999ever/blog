...
<div class="form-group">
    ...
    <textarea class="form-control" rows="6" id="texto" name="texto" placeholder="Escribe aquí tu artículo..."><?php echo $validador -> obtener_texto(); ?></textarea>
...
<div class="checkbox">
    <label>
        <input type="checkbox" name="publicar" value="si" <?php if ($validador -> obtener_checkbox()) {echo 'checked';} ?>>Marca si quieres que la entrada se publique
